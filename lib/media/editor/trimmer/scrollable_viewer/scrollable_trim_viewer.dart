...
import '../properties/trim_editor_painter.dart';
import '../properties/trim_area_properties.dart';
import '../properties/trim_editor_properties.dart';
import '../trimmer.dart' show Trimmer;
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      ...
      setState(() {
        ...
        final thumbnailWidget = ScrollableThumbnailViewer(
          ...
          thumbnailGenerator:
              (String videoPath, int timestamp, int quality) async {
                return null;
              },
        );
