...
/// Combines a list of color filter matrices into one.
///
/// The matrices are multiplied in order, starting with the identity matrix.
///
/// - [filterList]: List of 4x5 color filter matrices (e.g. sepia, grayscale).
///
/// Returns a single 4x5 matrix representing the combined effect.
List<double> mergeColorMatrices({required List<List<double>> filterList}) {
