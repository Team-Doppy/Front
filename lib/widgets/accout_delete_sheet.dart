...
class _AccountDeleteStrings {
  ...
  static const deleteAccountFinalConfirm =
      '한 번 탈퇴하면 복구할 수 없습니다. 그래도 탈퇴하시겠습니까?';
  static const deleteConfirm = '탈퇴하기';
...
class _AccountDeletionSheetState extends State<AccountDeletionSheet> {
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: _getReasons().asMap().entries.map((entry) {
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                borderRadius: BorderRadius.vertical(
                                  ...
                                  bottom: isLast && _selectedReason != 'other'
  ...
  bool _isButtonEnabled() {
    ...
    if (_selectedReason == 'other' &&
        _detailController.text.trim().isEmpty) return false;
    return true;
  }
  ...
  Future<bool?> _showConfirmDialog(BuildContext context) {
    return showDialog<bool>(
      ...
      builder: (c) => AlertDialog(
        title: const Text(_AccountDeleteStrings.deleteAccount),
        content: const Text(_AccountDeleteStrings.deleteAccountFinalConfirm),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(c, false),
            child: const Text(_AccountDeleteStrings.cancel),
          ),
          TextButton(
            ...
            child: const Text(_AccountDeleteStrings.deleteConfirm),
          ),
        ],
      ),
    );
  ...
  Future<void> _handleAccountDeletion(BuildContext context) async {
    ...
    final deletionSuccess = await _processDeletion(
      reasonKey: reasonKey,
      detail: detail,
    );
    ...
    Navigator.of(context, rootNavigator: true).pushAndRemoveUntil(
      MaterialPageRoute(
        builder: (_) => LoginScreen(deletionResult: deletionSuccess),
      ),
      (route) => false,
    );
  }
