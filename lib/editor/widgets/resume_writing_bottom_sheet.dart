...
class ResumeWritingBottomSheet extends StatefulWidget {
  ...
  const ResumeWritingBottomSheet({super.key, this.title});
  ...
  static Future<ResumeWritingChoice?> show(
    ...
    return showModalBottomSheet<ResumeWritingChoice>(
      ...
      builder: (context) => ResumeWritingBottomSheet(title: title),
    );
  }
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      context.tr('resume_writing_title'),
                      style: TextStyle(
                        fontSize: 18,
                    ...
                    _buildActionItem(
                      context,
                      label: context.tr('resume_writing_continue'),
                    ...
                    _buildActionItem(
                      context,
                      label: context.tr('resume_writing_new'),
