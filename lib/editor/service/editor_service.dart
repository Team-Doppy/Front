...
class EditorService extends ChangeNotifier {
  ...
  void _saveCurrentState({bool immediate = false}) {
    ...
    if (immediate) {
      ...
      _historyTimer = Timer(const Duration(milliseconds: 500), () {
        ...
        print('[EditorService] 📸 디바운싱 저장 (total: ${_undoStack.length})');
  ...
  void _trackChangeFromLog(DocumentChange change) {
    ...
    try {
      ...
      print('[EditorService] 변경 추적 실패: $e');
    }
  }
  ...
  void undo() {
    if (!canUndo) {
      print('[EditorService] ❌ Undo 불가 (첫 상태)');
      return;
    }
    ...
    try {
      ...
      print('[EditorService] ⬅️ Undo 완료 (남은: ${_undoStack.length})');
    } catch (e) {
      print('[EditorService] Undo 실패: $e');
    } finally {
  ...
  void redo() {
    if (!canRedo) {
      print('[EditorService] ❌ Redo 불가 (없음)');
      return;
    }
    ...
    try {
      ...
      print('[EditorService] ➡️ Redo 완료 (남은 redo: ${_redoStack.length})');
    } catch (e) {
      print('[EditorService] Redo 실패: $e');
    } finally {
      _isExecutingHistory = false;
      // 🎯 Undo/Redo 버튼 상태 업데이트
      notifyListeners();
  ...
  void _restoreFromSnapshot(_DocumentSnapshot snapshot) {
    ...
    try {
      ...
      print('[EditorService] Selection 클리어 실패: $e');
    }
    ...
    if (document.nodeCount == 0 ||
      ...
      print('[EditorService] 🛡️ 제목 복원 (빈 제목 추가)');
    }
    ...
    try {
      editor.composer.clearSelection();
      print('[EditorService] ✅ 커서 숨김');
    } catch (e) {
      print('[EditorService] 커서 숨기기 실패: $e');
    }
  }
  ...
  void _onDocumentChanged(DocumentChangeLog changeLog) {
    ...
    if ((change is TextInsertionEvent || change is TextDeletedEvent) &&
      ...
      try {
        ...
        if (nodeService.selectedNodeId != null) {
          ...
          print('[EditorService] 텍스트 변경 감지 -> 노드 선택 자동 해제');
        }
      } catch (e) {
    ...
    if (change is TextInsertionEvent) {
      try {
              ...
              if (currentText.length > mentionLength) {
                ...
                WidgetsBinding.instance.addPostFrameCallback((_) {
                  try {
                    ...
                    print('[EditorService] 멘션 텍스트 스타일 조정 실패: $e');
                  }
                });
              }
            }
        ...
        print('[EditorService] 멘션 텍스트 입력 처리 중 오류: $e');
      }
    }
          ...
          if (node != null && node is ParagraphNode) {
            ...
            if (isMention && usernames.isNotEmpty) {
              ...
              if (currentText.length > mentionLength) {
                ...
                if (nodeIndex == -1) {
                  print('[EditorService] 멘션 부분 삭제: 유효하지 않은 노드 인덱스');
                  return;
                }
                ...
                WidgetsBinding.instance.addPostFrameCallback((_) {
                  try {
                    ...
                    print('[EditorService] 커서 이동 실패: $e');
                  }
                });
              ...
              // 유효한 인덱스인지 확인
              if (nodeIndex == -1) {
                print('[EditorService] 멘션 삭제: 유효하지 않은 노드 인덱스');
                return;
              }
              ...
              if (nodeIndex + 1 < document.nodeCount) {
                try {
                  ...
                  print('[EditorService] 다음 노드 확인 실패: $e');
                }
              }
              ...
              if (targetPosition == null && nodeIndex > 1) {
                try {
                  ...
                  print('[EditorService] 이전 노드 확인 실패: $e');
                }
              }
              ...
              try {
                ...
                print('[EditorService] 커서 클리어 실패: $e');
              }

              // 노드 삭제
              try {
                document.deleteNode(targetNodeId);
                print('[EditorService] 멘션 노드 삭제 완료: $targetNodeId');
              } catch (e) {
                print('[EditorService] 멘션 노드 삭제 실패: $e');
                return;
              }
              ...
              if (savedTargetPosition != null) {
                  ...
                  WidgetsBinding.instance.addPostFrameCallback((_) {
                    ...
                    WidgetsBinding.instance.addPostFrameCallback((_) {
                      try {
                        ...
                        print('[EditorService] 커서 이동 실패: $e');
                        print('[EditorService] 스택 트레이스: $stackTrace');
                      }
                    });
                  });
                });
                ...
                print('[EditorService] 멘션 삭제: 커서 이동 위치 없음, 클리어 상태 유지');
              }
        ...
        if (insertedNode is ParagraphNode &&
          ...
          if (prevNode is ParagraphNode &&
            ...
            if (editor.composer.preferences.currentAttributions.contains(
              ...
              print('[EditorService] 멘션 노드 다음 문단 생성: 볼드 preference 제거');
            }
              ...
              if (hasBold) {
                ...
                WidgetsBinding.instance.addPostFrameCallback((_) {
                  try {
                    ...
                    print('[EditorService] 멘션 노드 다음 문단 볼드 제거 실패: $e');
                  }
                });
              }
            }
  ...
  void dispose() {
    ...
    _undoStack.clear();
    _redoStack.clear();
    print('[EditorService] 🧹 히스토리 스택 정리 완료');
  ...
  void mergeImagesIntoRow(
    ...
    print('[EditorService] 🔍 생성된 imageCommentInfo: $imageCommentInfo');
    ...
    try {
      ...
      _isExecutingHistory = false;
      _saveCurrentState(immediate: true);
      print('[EditorService] 🖼️ 이미지 병합 완료');
    }
  }
  ...
  void _addImageToRow(String imageId, String rowId, bool isFromLeft) {
    ...
    try {
      ...
      _isExecutingHistory = false;
      _saveCurrentState(immediate: true);
      print('[EditorService] 🖼️ ImageRow에 이미지 추가 완료');
    }
  }
  ...
  void addMentionNode(List<String> usernames) {
    ...
    try {
      ...
      print('[EditorService] 멘션 추가 실패: $e');
    } finally {
      // 🎯 작업 완료 후 히스토리 추적 재개 + 한 번만 저장
      _isExecutingHistory = false;
      _saveCurrentState(immediate: true);
      print('[EditorService] 📝 멘션 추가 완료');
    }
  }
  ...
  Future<void> replaceVideoPlaceholderWithUrl(
    ...
    try {
      ...
      final newNode = ClipNode(
        ...
        metadata:
            mediaId != null && mediaId.isNotEmpty ? {'mediaId': mediaId} : null,
      );
  ...
  String? splitImageFromRow(String rowId, int imageIndex, {int? insertIndex}) {
    ...
    try {
      ...
      _isExecutingHistory = false;
      _saveCurrentState(immediate: true);
      print('[EditorService] 🖼️ 이미지 분리 완료');
    }
  }
