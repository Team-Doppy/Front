...
class EditorConfig {
  ...
  /// 맨 위 제목 노드 기본 폰트 사이즈 (메타데이터 isTitle: true)
  static const double defaultTitleFontSize = 25.0;

  /// 제목 노드 수직 패딩 (top/bottom)
  static const double defaultTitleVerticalPadding = 12.0;

  /// 제목 노드 여부 메타데이터 키
  static const String titleNodeMetadataKey = 'isTitle';

  /// 발행 시 기본 공개범위 (draftData.visibility가 없을 때)
  static const AccessLevel defaultPublishAccessLevel = AccessLevel.private;
