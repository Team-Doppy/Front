...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'ko': {
      ...
      'friend_request_message': '{username}과 친구하기',
      'follow': '팔로우',
      'following': '팔로잉',
      'followers': '팔로워',
      'posts_count': '게시물',
      ...
      'no_received_requests': '받은 친구요청이 없습니다',
      'no_sent_requests': '보낸 친구요청이 없습니다',
      'accept': '수락',
      'reject': '거절',
      'add_friend': '친구 추가',
      'remove_friend': '친구 삭제',
      'remove_friend_confirm': '{name}님과의 친구 관계를 취소하시겠습니까?',
      'block_user': '차단하기',
      'report_user': '신고하기',
      ...
      'all_friends_group_name_not_editable': '전체 친구 그룹의 이름은 수정할 수 없습니다',
      'create': '생성',
      'add_with_count': '추가하기 ({count})',
      'no_friends_in_group': '아직 이 그룹에 친구가 없어요',
      ...
      'selected': '선택됨',
      'delete_selected_members': '선택한 멤버 삭제 ({count})',
      'unfriend_selected': '선택한 친구 해제 ({count})',
      'remove_members_confirm': '선택한 {count}명의 멤버를 삭제하시겠어요?',
      'unfriend_confirm_message': '선택한 {count}명의 친구를 해제하시겠어요?',
      'unfriend': '친구 해제',
      'remove': '삭제',
      'unfriend_success': '{count}명의 친구를 해제했습니다',
      'unfriend_failed': '친구 해제에 실패했습니다',
      'members_removed': '{count}명의 멤버를 삭제했습니다',
      'remove_member_failed': '멤버 삭제에 실패했습니다',
      'visit_profile': '프로필 방문',
      'remove_from_group': '그룹에서 제거',
      'member_removed_from_group': '{username}님을 그룹에서 제거했습니다',
      'send_friend_request': '친구 요청 보내기 ({count})',
      'friend_request_sent': '{count}명에게 친구 요청을 보냈습니다',
      'friend_request_failed': '친구 요청 보내기에 실패했습니다',
      'friend_request_accept_failed': '친구 요청 수락에 실패했습니다',
      'friend_request_reject_failed': '친구 요청 거절에 실패했습니다',
      'friend_request_cancel_failed': '친구 요청 취소에 실패했습니다',
      'friend_request_already_cancelled': '이미 취소된 요청입니다',
      'friend_request_cancelled': '{count}개의 친구 요청을 취소했습니다',
    ...
    'en': {
      ...
      'friend_request_message': 'Become friends with {username}',
      'follow': 'Follow',
      'following': 'Following',
      'followers': 'Followers',
      'posts_count': 'Posts',
      ...
      'remove_friend_confirm':
          'Would you like to remove {name} from your friends?',
      ...
      'selected': 'selected',
      'delete_selected_members': 'Delete selected members ({count})',
      'unfriend_selected': 'Unfriend selected ({count})',
      'remove_members_confirm': 'Delete {count} selected member(s)?',
      'unfriend_confirm_message': 'Unfriend {count} selected friend(s)?',
      'unfriend': 'Unfriend',
      'remove': 'Remove',
      'unfriend_success': 'Unfriended {count} friend(s)',
      'unfriend_failed': 'Failed to unfriend',
      'members_removed': 'Removed {count} member(s)',
      'remove_member_failed': 'Failed to remove member',
      'visit_profile': 'Visit Profile',
      'remove_from_group': 'Remove from Group',
      'member_removed_from_group': 'Removed {username} from group',
      'send_friend_request': 'Send Friend Request ({count})',
      'friend_request_sent': 'Sent friend request to {count} user(s)',
      ...
      'friend_request_cancel_failed': 'Failed to cancel friend request',
      'friend_request_cancelled': 'Cancelled {count} friend request(s)',
