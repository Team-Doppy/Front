...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'ko': {
      ...
      'profile': '프로필',
      'notifications': '알림',
      'notification_screen_title': '내 알림',
      'today': '오늘',
      'this_week': '이번 주',
      'this_month': '이번 달',
      'earlier': '이전',
      'no_notifications': '알림이 없습니다',
      'failed_to_load_notifications': '알림을 불러오는데 실패했습니다',
      'friends_posts': '친구글',
      'my_network_feed': '',
      'all_posts': '전체글',
      'all': '모든 포스트',
      ...
      'decide_later': '나중에 결정',
      'expires_in_1_month': '1개월 후 만료',
      'expires_in_weeks': '{weeks}주 후 만료',
      ...
      'join_enter_email_subtitle_signup_initial': '안전한 이용을 위해 이메일 인증이 필요해요',
      'join_enter_email_subtitle_signup': '메일로 발송된 6자리 인증번호를 입력해주세요',
      ...
      'error_password_too_long': '비밀번호는 최대 128자까지 가능합니다.',
      'error_password_same_as_old': '기존 비밀번호와 동일한 비밀번호는 사용할 수 없습니다.',
      'error_password_change_failed': '비밀번호 변경에 실패했습니다.',
      'password_change_success': '비밀번호가 성공적으로 변경되었습니다.',
      'error_verification_code_expired': '인증 코드가 만료되었습니다. 다시 인증해주세요.',
      'error_verification_code_invalid': '인증 코드가 올바르지 않습니다.',
      'error_verification_code_expired_or_invalid': '인증 코드가 올바르지 않거나 만료되었습니다.',
      'error_email_not_found': '해당 이메일로 등록된 사용자를 찾을 수 없습니다.',
      'error_rate_limit_exceeded': '잠시 후 다시 시도해주세요.',
      'error_email_required': '이메일을 입력해주세요.',
      'error_invalid_email_format': '유효하지 않은 이메일 형식입니다.',
    ...
    'en': {
      ...
      'expires_in_1_month': 'Expires in 1 month',
      'expires_in_weeks': 'Expires in {weeks} weeks',
      ...
      'error_password_too_long': 'Password must be at most 128 characters.',
      'error_password_same_as_old':
          'Cannot use the same password as your current password.',
      'error_password_change_failed': 'Failed to change password.',
      'password_change_success': 'Password has been successfully changed.',
      'error_verification_code_expired':
          'Verification code has expired. Please verify again.',
      'error_verification_code_invalid': 'Invalid verification code.',
      'error_verification_code_expired_or_invalid':
          'Verification code is invalid or has expired.',
      'error_email_not_found': 'No user registered with this email address.',
      'error_rate_limit_exceeded': 'Please try again later.',
      ...
      'join_enter_email_subtitle_signup_initial':
          'Email verification is required for safe use',
      'join_enter_email_subtitle_signup':
      ...
      'login_welcome': 'Wellcome!',
      'login_title': 'Sign in',
      'login_subtitle': 'Please fill your informations',
      'login_id_label': 'Doppy ID',
      'login_id_hint': 'Enter your ID',
      'login_password_label': 'Password',
      'login_button': 'Sign in now',
      'forgot_id_password': 'Forgot ID or Password?',
      'signup_link': 'Sign up',
