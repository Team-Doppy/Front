import 'color_filter_addons.dart';
...
class FilterModel {
  ...
  /// Gets the combined filter matrix for this filter.
  List<double> getMatrix() {
    return mergeColorMatrices(filterList: filters);
  }
}
...
class PresetFilters {
  /// NoFilter: No filter
  static FilterModel none = const FilterModel(name: '원본', filters: []);
